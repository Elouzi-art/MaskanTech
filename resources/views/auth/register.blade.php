...
<div class="register-wrap">
    ...
    {{-- RIGHT --}}
    <div class="right">
        <a href="/" class="mk-logo" style="margin-bottom:32px;display:flex;">
        ...
        <form>
            ...
            <div class="student-section" id="student-section">
                ...
                <input type="text" placeholder="Nom de votre université / école">
            ...
            <div class="cin-section" id="cin-section">
                ...
                <div class="extra-desc">Pour garantir la sécurité de notre plateforme, nous avons besoin d'une copie de votre CIN. Votre profil sera activé après validation par notre équipe.</div>
                <label class="cin-upload" onclick="document.getElementById('cin-file').click()">
                    ...
                    <input type="file" id="cin-file" accept="image/*,.pdf" onchange="showFileName(this)" style="display:none;">
                </label>
