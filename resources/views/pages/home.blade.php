...
<body>
    ...
    <section class="hero">
        ...
        <div class="search-bar">
            ...
            <select><option>Tout type</option><option>Appartement</option><option>Studio</option><option>Chambre</option><option>Colocation</option></select>
            <select><option>Budget max</option><option>1 000 MAD</option><option>2 000 MAD</option><option>3 000 MAD</option><option>5 000 MAD</option></select>
            <button>Rechercher</button>
        </div>
    </section>
    <div class="stats">
        <div class="stat"><div class="stat-number">1 200+</div><div class="stat-label">Annonces disponibles</div></div>
        <div class="stat"><div class="stat-number">8 000+</div><div class="stat-label">Utilisateurs satisfaits</div></div>
        <div class="stat"><div class="stat-number">50+</div><div class="stat-label">Villes au Maroc</div></div>
        <div class="stat"><div class="stat-number">100%</div><div class="stat-label">Annonces vérifiées</div></div>
    </div>
    <section class="features">
        <h2>Pourquoi choisir MaskanTech ?</h2>
        <div class="features-grid">
            <div class="feature-card"><div class="feature-icon">✅</div><div class="feature-title">Annonces vérifiées</div><div class="feature-desc">Chaque annonce est validée manuellement par notre équipe</div></div>
            <div class="feature-card"><div class="feature-icon">💬</div><div class="feature-title">Contact direct</div><div class="feature-desc">Messagerie sécurisée sans intermédiaire</div></div>
            <div class="feature-card"><div class="feature-icon">🎓</div><div class="feature-title">Espace étudiant</div><div class="feature-desc">Logements dédiés aux étudiants partout au Maroc</div></div>
            <div class="feature-card"><div class="feature-icon">🔒</div><div class="feature-title">Zéro commission</div><div class="feature-desc">Relation directe propriétaire et locataire</div></div>
        </div>
    </section>
        ...
        <div class="annonces-grid">
            <div class="annonce-card">
                ...
                <div class="annonce-body">
                    <span class="badge badge-blue">Studio</span> <span class="badge badge-green">Étudiant accepté</span>
            ...
            <div class="annonce-card">
                <div class="annonce-img">🏢</div>
                <div class="annonce-body">
                    <span class="badge badge-blue">Colocation</span> <span class="badge badge-purple">Étudiant uniquement</span>
